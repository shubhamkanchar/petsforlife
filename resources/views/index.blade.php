			...
			<div class="container">
				...
				<div class="collapse navbar-collapse w-100 order-3 dual-collapse2" id="navbarSupportedContent-7">
					<ul class="navbar-nav ml-auto">
						...
						<!-- <li class="nav-item">
							<a class="btn btn-success" href="{{ route('pet-form')}}">Login</a>
						</li> -->
					</ul>
				</div>
			</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12 white-text text-center">
							...
							<h5 class="text-uppercase pt-md-5 pt-sm-2 pt-5 pb-md-5 pb-sm-3 pb-5 white-text font-weight-bold wow fadeInDown" data-wow-delay="0.3s" style="letter-spacing: 3px;">Best platform to buy and Sell puppies online</h5>
			...
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="row" id="ad_html">
						@foreach($post as $p)
						<div class="col-sm-6 col-md-4 col-xl-3 col-12 col-lg-4">
							<div class="card mb-5">
