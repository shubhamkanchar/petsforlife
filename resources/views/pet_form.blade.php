                            ...
                            <div class="card" style="padding: 20px;">
                                ...
                                <form id="pet_form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="available_puppies">Number Male of puppies available</label>
                                                <input class="form-control" placeholder="Please enter no. of male puppies available" type="number" name="available_puppies_male" id="available_puppies_male">
                                            </div>
                                            <div class="form-group">
                                                <label for="available_puppies">Number Female of puppies available</label>
                                                <input class="form-control" placeholder="Please enter no. of female puppies available" type="number" name="available_puppies_female" id="available_puppies_female">
                                            </div>
                                            <div class="form-group">
